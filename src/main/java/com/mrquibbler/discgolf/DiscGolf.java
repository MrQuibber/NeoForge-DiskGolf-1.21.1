package com.mrquibbler.discgolf;

import com.mrquibbler.discgolf.item.ModItems;
...
public class DiscGolf {
    public static final String MOD_ID = "discgolf";
    private static final Logger LOGGER = LogUtils.getLogger();

    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public DiscGolf(IEventBus modEventBus, ModContainer modContainer) {
